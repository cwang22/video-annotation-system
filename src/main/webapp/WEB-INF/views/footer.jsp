	...
	<script src="<c:url value="/resources/assets/js/retina-1.1.0.js" />"></script>
	<script src="<c:url value="/resources/assets/js/jquery.hoverdir.js" />"></script>
	<script src="<c:url value="/resources/assets/js/jquery.hoverex.min.js" />"></script>
	...
	<script src="<c:url value="/resources/assets/js/jquery.dragsort-0.5.2.min.js" />"></script>
